...
module.exports = (registry, topic, schemaString, type = 'value', requestId) => new Promise((resolve, reject) => {
  ...
  const req = protocol.request(requestOptions, (res) => {
    ...
    res.on('end', () => {
      if (res.statusCode !== 200) {
        ...
        return reject(new Error(`Schema registry error: requestId: ${requestId}, code: ${error.error_code} - ${error.message}`));
      }
